    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-4">
      <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 min-h-[500px]">
          ...
          {currentStep === 'confirm' && <StepConfirm t={t} patient={patient} onNext={() => setCurrentStep('appointment')} />}
...
function StepConfirm({ t, patient, onNext }) {
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-blue-50 p-6 rounded-lg mb-4">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm"><p><strong>{t.patientId}:</strong> {patient.id}</p><p><strong>{t.dob}:</strong> {patient.dob}</p><p className="col-span-2"><strong>{t.address}:</strong> {patient.address}</p></div>
      </div>
